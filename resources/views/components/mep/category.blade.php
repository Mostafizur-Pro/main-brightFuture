<div class="w-4/5">
    ...
    <div>
        ...
        <div class=" my-2 ">
            <li className="my-5">
                <a href="{{url('/mep/hvac')}}">HVAC Design</a>
            </li>
            <li className="my-5">
                <a href="{{url('/mep/electrical')}}">Elecrical Design</a>
            </li>
            <li className="my-5">
                <a href="{{url('/mep/plumbing')}}">Plumbing Design</a>
            </li>
            <li className="my-5">
                <a href="{{url('/mep/fire')}}">Fire Design</a>
            </li>
