<div class="w-4/5">
    ...
    <div>
        ...
        <div class=" my-2 ">
            ...
            <li className="my-5">
                <a href="{{url('/react-development')}}">React Development </a>
            </li>
            <li className="my-5">
                <a href="{{url('/redux-development')}}">Redux Development </a>
            </li>
            <li className="my-5">
                <a href="{{url('/nextjs-development')}}">NextJS Development </a>
            </li>
            <li className="my-5">
                <a href="{{url('/laravel-development')}}">Laravel Development </a>
            </li>
        </div>
    </div>
    <hr class="my-10" />
