        ...
        <div class="card flex-shrink-0 w-full max-w-md p-6 shadow-2xl bg-white">
            ...
            <form method="POST" action="{{ route('register') }}" class="card-body">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter your full name" class="input input-bordered" required />
                </div>
                <div class="form-control mt-4">
                    <label class="label">
                        <span class="label-text">Email</span>
                    </label>
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" class="input input-bordered" required />
                </div>
                <div class="form-control mt-4">
                    <label class="label">
                        <span class="label-text">Password</span>
                    </label>
                    <input type="password" name="password" placeholder="Create a password" class="input input-bordered" required />
                </div>
                <div class="form-control mt-4">
                    <label class="label">
                ...
                <p>Already have an account? <a class="text-blue-400" href="{{ route('login') }}">Please Login</a></p>
            </form>
        </div>
