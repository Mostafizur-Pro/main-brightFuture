      ...
      <div class="card flex-shrink-0 w-full max-w-md p-6 shadow-2xl bg-white">
        ...
        <form method="POST" action="{{ route('login') }}" class="card-body">
          ...
          <div class="form-control mt-4">
            ...
            <input type="password" name="password" placeholder="Enter your password" class="input input-bordered" required />
          </div>
          ...
          <p>Create a new account! <a class="text-blue-400" href="{{ url('/register') }}">Please Register</a></p>
        </form>
      </div>
